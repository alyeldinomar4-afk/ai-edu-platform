...
const LoginPage = () => {
    ...
    return (
        <div className="transition-colors duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 animate-slide-up [animation-delay:300ms] opacity-0 [animation-fill-mode:forwards]">
                <div>
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="remember-me" className="ml-2 block text-sm text-slate-500 dark:text-slate-400 cursor-pointer hover:text-slate-700 dark:hover:text-slate-300">
                            {t('auth.login.rememberMe')}
                        </label>
                    </div>

                    <div className="text-sm">
                                <Link to="/forgot-password" size="sm" className="font-medium text-primary hover:text-primary-dark cursor-pointer font-bold">
            ...
            <p className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400 animate-slide-up [animation-delay:500ms] opacity-0 [animation-fill-mode:forwards]">
                ...
                <Link to="/register" className="font-bold text-primary hover:text-primary-dark cursor-pointer underline underline-offset-4">
                    {t('auth.login.signUp')}
                </Link>
            </p>
        </div>
