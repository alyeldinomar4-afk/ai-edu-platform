...
const RegisterPage = () => {
    ...
    return (
        <div className="transition-colors duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-5 animate-slide-up [animation-delay:200ms] opacity-0 [animation-fill-mode:forwards]">
                <div>
                    <label htmlFor="name" className="block text-sm font-medium text-slate-700 dark:text-slate-300 ml-1">
                ...
                <Button
                    type="submit"
                    disabled={loading}
                    className="w-full justify-center h-12 shadow-lg shadow-primary/20 mt-2"
                >
                    {loading ? <Loader2 className="animate-spin" /> : t('auth.register.submit')}
                </Button>
            </form>

            <div className="mt-8 animate-slide-up [animation-delay:300ms] opacity-0 [animation-fill-mode:forwards]">
            ...
            <p className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400 animate-slide-up [animation-delay:400ms] opacity-0 [animation-fill-mode:forwards]">
                {t('auth.register.hasAccount')}{' '}
                <Link to="/login" className="font-bold text-primary hover:text-primary-dark cursor-pointer underline underline-offset-4">
