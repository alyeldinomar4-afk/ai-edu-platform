...
const SmartLearningSection = () => {
    ...
    return (
        <section className="relative w-full py-16 sm:py-24 overflow-visible bg-slate-50 dark:bg-[#060B14]">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 flex flex-col items-center text-center">
                ...
                <motion.div 
                    ...
                    className="w-full text-center mb-10 sm:mb-16 relative z-20"
                >
                    ...
                    <h2 className="text-2xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight mb-4 [text-shadow:_0_0_30px_rgba(255,255,255,0.1)] leading-[1.2]">
                        {isAr ? 'مسارات تعلم ' : 'Intelligent '}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 via-indigo-600 to-purple-600 dark:from-cyan-400 dark:via-indigo-400 dark:to-purple-400 block sm:inline">
                ...
                <div className="relative w-full max-w-4xl mx-auto h-[400px] sm:h-[500px] mb-8 flex items-center justify-center">
                    ...
                    >
                        <div className="relative w-40 h-40 sm:w-56 sm:h-56 rounded-full border border-indigo-500/20 dark:border-indigo-500/40 bg-white/40 dark:bg-indigo-950/40 backdrop-blur-md flex items-center justify-center shadow-[0_0_80px_rgba(79,70,229,0.15)] dark:shadow-[0_0_80px_rgba(79,70,229,0.4)]">
                            ...
                            <motion.div animate={{ rotate: 360, rotateX: 45, rotateY: 45 }} transition={{ duration: 12, repeat: Infinity, ease: "linear" }} className="absolute inset-[-20px] sm:inset-[-30px] border border-indigo-400/20 rounded-full" style={{ transformStyle: 'preserve-3d' }}>
                                <div className="absolute bottom-0 left-1/2 w-2 h-2 sm:w-3 sm:h-3 bg-indigo-400 rounded-full shadow-[0_0_10px_#818cf8] -translate-x-1/2 translate-y-1/2" style={{ transform: 'rotateX(-45deg) rotateY(-45deg)' }} />
                            </motion.div>

                            {/* Connecting Lines to Cards (Static decorative lines) */}
                            <svg className="absolute inset-[-100px] sm:inset-[-150px] w-[calc(100%+200px)] sm:w-[calc(100%+300px)] h-[calc(100%+200px)] sm:h-[calc(100%+300px)] pointer-events-none opacity-30" viewBox="0 0 400 400">
                    ...
                    >
                        <div className="w-full h-14 sm:h-28 rounded-xl overflow-hidden relative mb-2 sm:mb-3">
                            ...
                            <div className="absolute top-1 sm:top-2 right-1 sm:right-2 z-20 w-5 h-5 sm:w-8 sm:h-8 rounded-full bg-black/40 backdrop-blur-md flex items-center justify-center border border-white/20">
                                <Brain className="w-2.5 h-2.5 sm:w-4 sm:h-4 text-white" />
                            </div>
                        </div>
                        <h3 className="text-white text-[9px] sm:text-base font-bold leading-tight px-1 text-start">{isAr ? 'الذكاء الاصطناعي' : 'AI & ML'}</h3>
                        <div className="flex items-center gap-1 mt-0.5 sm:mt-2 mb-0.5 sm:mb-1 px-1 text-[7px] sm:text-[10px] text-white/80">
                            <Star className="w-2 h-2 sm:w-3 sm:h-3 fill-yellow-400 text-yellow-400" /> <span className="font-bold">5.0</span>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="w-full h-14 sm:h-28 rounded-xl overflow-hidden relative mb-2 sm:mb-3">
                            ...
                            <div className="absolute top-1 sm:top-2 right-1 sm:right-2 z-20 w-5 h-5 sm:w-8 sm:h-8 rounded-full bg-black/40 backdrop-blur-md flex items-center justify-center border border-white/20">
                                <Database className="w-2.5 h-2.5 sm:w-4 sm:h-4 text-white" />
                            </div>
                        </div>
                        <h3 className="text-white text-[9px] sm:text-base font-bold leading-tight px-1 text-start">{isAr ? 'علم البيانات' : 'Data Science'}</h3>
                        <div className="flex items-center gap-1 mt-0.5 sm:mt-2 mb-0.5 sm:mb-1 px-1 text-[7px] sm:text-[10px] text-white/80">
                            <Star className="w-2 h-2 sm:w-3 sm:h-3 fill-yellow-400 text-yellow-400" /> <span className="font-bold">4.8</span>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="w-full h-14 sm:h-28 rounded-xl overflow-hidden relative mb-2 sm:mb-3">
                            ...
                            <div className="absolute top-1 sm:top-2 right-1 sm:right-2 z-20 w-5 h-5 sm:w-8 sm:h-8 rounded-full bg-black/40 backdrop-blur-md flex items-center justify-center border border-white/20">
                                <Code2 className="w-2.5 h-2.5 sm:w-4 sm:h-4 text-white" />
                            </div>
                        </div>
                        <h3 className="text-white text-[9px] sm:text-base font-bold leading-tight px-1 text-start">{isAr ? 'بايثون' : 'Python'}</h3>
                        <div className="flex items-center gap-1 mt-0.5 sm:mt-2 mb-0.5 sm:mb-1 px-1 text-[7px] sm:text-[10px] text-white/80">
                            <Star className="w-2 h-2 sm:w-3 sm:h-3 fill-yellow-400 text-yellow-400" /> <span className="font-bold">4.9</span>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="w-full h-14 sm:h-28 rounded-xl overflow-hidden relative mb-2 sm:mb-3">
                            ...
                            <div className="absolute top-1 sm:top-2 right-1 sm:right-2 z-20 w-5 h-5 sm:w-8 sm:h-8 rounded-full bg-black/40 backdrop-blur-md flex items-center justify-center border border-white/20">
                                <PenTool className="w-2.5 h-2.5 sm:w-4 sm:h-4 text-white" />
                            </div>
                        </div>
                        <h3 className="text-white text-[9px] sm:text-base font-bold leading-tight px-1 text-start">{isAr ? 'تصميم UI/UX' : 'UI/UX Design'}</h3>
                        <div className="flex items-center gap-1 mt-0.5 sm:mt-2 mb-0.5 sm:mb-1 px-1 text-[7px] sm:text-[10px] text-white/80">
                            <Star className="w-2 h-2 sm:w-3 sm:h-3 fill-yellow-400 text-yellow-400" /> <span className="font-bold">4.7</span>
                        </div>
                    </motion.div>
                </div>
            </div>
